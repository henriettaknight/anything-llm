const TRANSLATIONS = {
  ...
  "vector-workspace": {
    ...
    doc: {
      ...
      zero: "No restriction",
      hybrid: "Hybrid only (similarity score ≥ .10)",
  ...
  autodetection: {
    title: "Code Review",
    description: "Code defect detection",
    loading: "Loading...",
    error: "Error",
    config: {
      title: "Configuration",
      directory: "Target Directory",
      directoryPlaceholder: "No directory selected",
      selectButton: "Select",
      selecting: "Selecting...",
      clearButton: "Clear",
      detectionTime: "Detection Time",
      timeFormat: "HH:mm",
      timeHint: "Detection will run daily at this time",
      reportUnit: {
        section: "Staged Reports (Report Units)",
        threshold: "Unit Split Threshold (KB)",
        thresholdHint: "Files in the same folder are split into report units (a1/a2/root1…) once their cumulative size exceeds this value; a staged report downloads immediately when each unit completes. 0 = no split (single report after full detection)",
        maxFiles: "Max Files per Unit",
        maxFilesHint: "Prevents many small files from overloading a single unit's report; usually no need to change",
        stageDownload: "Enable staged report download",
        stageDownloadHint: "Download a small staged report as each unit completes; a full summary package is still downloaded at the end. Chrome will ask for 'download multiple files' permission on first use — please allow",
      },
      saveButton: "Save Configuration",
      saving: "Saving...",
      info: "How it works",
      infoStep1: "Select a directory containing C++ source files",
      infoStep2: "Set the time when detection should run daily",
      infoStep3: "System will automatically scan and analyze files at the specified time",
      error: {
        directoryRequired: "Please select a directory",
        timeRequired: "Please enter a detection time",
        invalidTimeFormat: "Time must be in HH:mm format (e.g., 14:30)",
        saveFailed: "Failed to save configuration",
        directorySelectionFailed: "Failed to select directory",
        fileSystemNotSupported: "File System API is not supported in your browser",
      },
      warning: {
        browserSupport: "Browser Compatibility",
        fileSystemNotSupported: "Your browser does not support the File System API. Please use Chrome, Edge, or Opera 86+",
      },
    },
    status: {
      title: "Status",
      ...
      progress: "Progress",
      progressFiles: "Files",
      groupsDetected: "Groups detected: {{completed}}/{{total}}",
      ...
      infoIdle: "Idle: Waiting for the scheduled detection time",
      infoRunning: "Running: Detection is in progress",
      infoError: "Error: An error occurred during detection",
    },
    reports: {
      title: "Reports",
      tab: "Reports",
      ...
      deleteAllWarning: "This action cannot be undone. All reports will be permanently deleted.",
      cancel: "Cancel",
      empty: "No reports yet",
      emptyHint: "Reports will appear here after detection completes",
      info: "Report Information",
      infoStep1: "Each report is packaged as a ZIP file containing CSV reports and HTML summary",
      infoStep2: "Download ZIP packages to analyze defects and trends",
      infoStep3: "Delete reports to manage storage space",
    ...
    usage: {
      ...
      emptyHint: "Usage will be tracked after code review completes",
      summary: {
      ...
      legend: {
        deepseek: "DS = DeepSeek ($0.27/$1.10 per 1M)",
        claude: "CL = Claude Sonnet 4.6 ($3/$15 per 1M)",
        exchangeRate: "Exchange rate: 1 USD = 7.2 CNY",
      },
    },
    session: {
