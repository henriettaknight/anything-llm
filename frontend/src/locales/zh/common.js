...
const TRANSLATIONS = {
  ...
  autodetection: {
    ...
    config: {
      title: "配置",
      directory: "目标目录",
      directoryPlaceholder: "未选择目录",
      selectButton: "选择",
      selecting: "选择中...",
      clearButton: "清除",
      detectionTime: "检测时间",
      timeFormat: "HH:mm",
      timeHint: "检测将在每天的此时间运行",
      reportUnit: {
        section: "分阶段报告 (Report Units)",
        threshold: "单元拆分阈值 (KB)",
        thresholdHint: "同目录累计文件大小超过该值即拆为新报告单元（a1/a2/root1…），每单元完成立即下载一份阶段报告。0 = 不拆分（全部完成后一次性出报告）",
        maxFiles: "单元文件数上限",
        maxFilesHint: "防止大量小文件挤进同一单元导致报告过大，一般无需调整",
        stageDownload: "启用阶段报告下载",
        stageDownloadHint: "开启后每单元完成即下载阶段报告小包；检测结束时仍会下载完整汇总包。首次使用 Chrome 会弹出「允许下载多个文件」授权，请选择允许",
      },
      saveButton: "保存配置",
      saving: "保存中...",
      info: "工作原理",
      infoStep1: "选择包含 C++ 源文件的目录",
      infoStep2: "设置每天检测应运行的时间",
      infoStep3: "系统将在指定时间自动扫描和分析文件",
      error: {
        directoryRequired: "请选择一个目录",
        timeRequired: "请输入检测时间",
        invalidTimeFormat: "时间格式必须为 HH:mm（例如 14:30）",
        saveFailed: "保存配置失败",
    ...
    status: {
      ...
      progress: "进度",
      progressFiles: "文件",
      groupsDetected: "检测到的分组: {{completed}}/{{total}}",
      nextDetection: "下次检测",
      waitingForDetection: "等待检测",
      countdownDays: "{{days}}天 {{hours}}小时 {{minutes}}分钟",
      ...
      retrying: "重试中...",
      info: "状态信息",
      infoIdle: "空闲: 等待计划的检测时间",
      infoRunning: "运行中: 检测正在进行",
      infoError: "错误: 检测过程中发生错误",
    },
    reports: {
      title: "报告",
      tab: "报告",
      ...
      downloading: "下载中...",
      deleteButton: "删除",
      deleteAllButton: "删除所有",
      delete: "删除",
      deleting: "删除中...",
      deleteConfirm: "确定要删除此报告吗?",
      confirmDelete: "确认删除",
      confirmDeleteAll: "删除所有报告?",
      deleteAllWarning: "此操作无法撤销。所有报告将被永久删除。",
      cancel: "取消",
      empty: "暂无报告",
      emptyHint: "检测完成后，报告将显示在此处",
      info: "报告信息",
      infoStep1: "每个报告都打包为 ZIP 文件，包含 CSV 报告和 HTML 摘要",
      infoStep2: "下载 ZIP 包以分析缺陷和趋势",
      infoStep3: "删除报告以管理存储空间",
      rootDirectory: "根目录",
      report: "报告",
      groupName: "分组",
    },
    usage: {
      ...
      legend: {
        deepseek: "DS = DeepSeek（输入 $0.27/1M，输出 $1.10/1M）",
        claude: "CL = Claude Sonnet 4.6（输入 $3/1M，输出 $15/1M）",
        exchangeRate: "汇率按 1 USD = 7.2 CNY",
      },
    },
    error: {
      loadFailed: "加载配置失败",
