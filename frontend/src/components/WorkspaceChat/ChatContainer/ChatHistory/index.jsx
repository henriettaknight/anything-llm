...
export default function ChatHistory({
  ...
  if (history.length === 0 && !hasAttachments) {
    return (
      <div className="flex flex-col flex-1 min-h-0 md:mt-0 pb-44 md:pb-40 w-full justify-end items-center">
  ...
  return (
    <div
      className={`markdown text-white/80 light:text-theme-text-primary font-light ${textSizeClass} flex-1 min-h-0 pb-2 pt-6 md:pt-0 md:pb-2 md:mx-0 overflow-y-scroll flex flex-col justify-start ${showScrollbar ? "show-scrollbar" : "no-scroll"}`}
      id="chat-history"
      ref={chatHistoryRef}
